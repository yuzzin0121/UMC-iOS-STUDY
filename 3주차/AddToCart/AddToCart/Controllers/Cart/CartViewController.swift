...
class CartViewController: UIViewController {
    ...
    func setLayout() {
        ...
        NSLayoutConstraint.activate([
            ...
            infoStackView.leadingAnchor.constraint(equalTo: infoHeaderView.leadingAnchor, constant: 12),
            infoStackView.trailingAnchor.constraint(equalTo: infoHeaderView.trailingAnchor, constant: -12),
